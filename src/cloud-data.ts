...
export const regions = [
  { code: 'us-east-1', name: 'N. Virginia', factor: 1, status: 'healthy' as const },
  { code: 'sa-east-1', name: 'Sao Paulo', factor: 1.25, status: 'healthy' as const },
  { code: 'eu-west-1', name: 'Ireland', factor: 1.1, status: 'review' as const },
]
